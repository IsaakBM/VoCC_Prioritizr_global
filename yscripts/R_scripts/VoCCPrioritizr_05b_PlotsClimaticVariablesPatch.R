    ...
    # RCE PLOTS
      p2 <- ((rce_shp_plots[[1]] / rce_shp_plots[[4]] / rce_shp_plots[[7]]) | 
        ...
        plot_annotation(tag_prefix = "",
                        ...
                        tag_suffix = ".",) +
        theme_opts3 +
        ggsave(paste(outdir, paste("RCE-general", ".pdf", sep = ""), sep = ""), width = 35, height = 30, dpi = 300)
    # VoCC PLOTS
      p3 <- ((vocc_shp_plots[[1]] / vocc_shp_plots[[4]] / vocc_shp_plots[[7]]) | 
        ...
        plot_annotation(tag_prefix = "",
                        ...
                        tag_suffix = ".",) +
        theme_opts3 +
        ggsave(paste(outdir, paste("VOCC-general", ".pdf", sep = ""), sep = ""), width = 35, height = 30, dpi = 300)
}
...
system.time(general_plots(path = "wgeneral_figs",
