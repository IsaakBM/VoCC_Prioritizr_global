...
####################################################################################
####### 4.- Plot Climate velocity
####################################################################################



str_remove(ifelse(stringr::str_detect(string = basename(files.nc[1]), pattern = "ssp126"),
                  unlist(strsplit(unlist(str_split(files.nc[1], pattern = "/"))[3], split = "_"))[2], ""), pattern = "Layer")
